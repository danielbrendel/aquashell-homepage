<div class="content margin-fix is-left-aligned">
    ...
    <p>
        <a class="button is-success" href="{{ asset('downloads/AquaShell_build.zip') }}">Download version 1.0</a>
    </p>
        ...
        <div class="info-list">
            ...
            <div class="info-list-item">
                <div class="info-list-header">
                    ...
                    <div class="info-list-header-button"><a class="button is-link" href="https://github.com/danielbrendel/aquahots-tool">Download</a></div>
                </div>
